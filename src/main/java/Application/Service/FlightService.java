...
public class FlightService {
    ...
    public Flight updateFlight(int flight_id, Flight flight){
        Flight uFlight = flightDAO.getFlightById(flight_id);
        if (uFlight == null) {
            return null;
        }
    ...
    public List<Flight> getAllFlights() {
        List<Flight> flight = flightDAO.getAllFlights();
        return flight;
    }
    ...
    public List<Flight> getAllFlightsFromCityToCity(String departure_city, String arrival_city) {
        List<Flight> fly = flightDAO.getAllFlightsFromCityToCity(departure_city, arrival_city);
        return fly;
    }
}
